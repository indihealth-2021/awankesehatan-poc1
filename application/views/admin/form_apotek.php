                ...
                <div class="form-group gender-select">
                  <div class="form-check-inline">
                    <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="aktif" id="status" value=1 <?php if(isset($old)){ echo $old['aktif'] == 1 ? 'checked' : ''; } ?> required>Aktif
                    </label>
                  </div>
                  <div class="form-check-inline pl-2">
                    <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="aktif" id="status" value=0 <?php if(isset($old)){ echo $old['aktif'] == 0 ? 'checked' : ''; } ?> required>Non Aktif
                    </label>
                  </div>
                </div>
              </div>
