  ...
  <div class="content">
      ...
      <div class="col-sm-12 col-12 ">
        <nav aria-label="">
          <ol class="breadcrumb" style="background-color: transparent;">
            ...
            <li class="breadcrumb-item " aria-current="page"><a href="<?php echo base_url('admin/AdminApotek/') ?>" class="text-black">User Management</a></li>
            <li class="breadcrumb-item" aria-current="page"><a href="<?php echo base_url('admin/AdminApotek/form_admin_apotek') ?>" class="text-black font-bold-7">Tambah Admin Apotek</a></li>
          </ol>
        </nav>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="row">
          <div class="col-md-4">
            <?php $old = $this->session->flashdata('old_form');
            $error = $this->session->flashdata('error'); ?>
            <div class="form-group form-focus">
              <label class="focus-label">Username</label>
              <input type="text" class="form-control floating" value="" name="username" id="username" <?php //echo $error != 'username' && $error != 'usernameAndEmail' ? 'value="'.$old['username'].'"' : '' 
          ...
          <div class="col-md-4">
            <div class="form-group form-focus">
              ...
              <input type="email" class="form-control floating" name="email" id="email" <?php //echo $error != 'email' && $error != 'usernameAndEmail' ? 'value="'.$old['email'].'"' : '' 
            ...
            <div class="form-group form-focus">
              ...
              <select class="form-control floating" name="id_apotek" id="apotek">
                <?php foreach ($list_apotek as $apotek) { ?>
                  <option value="<?= $apotek->id ?>"><?= $apotek->nama ?></option>
                <?php } ?>
              </select>
            </div>
          </div>
                ...
                <div class="form-group gender-select">
                  <div class="form-check-inline">
                    <label class="form-check-label">
                      <input type="radio" class="form-check-input" name="jenis_kelamin" class="form-check-input" value="Perempuan" <?php if ($old) {
        ...
        <div class="row">
          <div class="col-sm-12 font-14">
            ...
            <div class="form-group gender-select">
              <div class="form-check-inline">
                <label class="form-check-label">
                  <input type="radio" class="form-check-input" name="aktif" id="status" value=1 <?php if ($old) {
              ...
              <div class="form-check-inline pl-2">
                <label class="form-check-label">
                  <input type="radio" class="form-check-input" name="aktif" id="status" value=0 <?php if ($old) {
