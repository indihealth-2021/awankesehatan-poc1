...
if(data.status == "OK"){
    ...
    public function getOngkir()
    {
        ...
        if (!$penerima) {
            $data = array(
                'success' => false,
                'message' => 'ERROR: Data penerima tidak ditemukan!'
            );
