    ...
    <div class="content">
      <div class="row mb-3">
        <div class="col-sm-12 col-12 ">
          ...
          <span class="btn btn-info p-1 m-3"><span class="p-2">ðŸ“Œ <?= "#" . $apotek->id . " - " . $apotek->nama . " , " . $apotek->alamat_jalan ?></span></span>
        </div>
        <div class="col-sm-12 col-12">
                  ...
                  <?php if (count($list_resep) > 0) { ?>
                    <?php foreach ($list_resep as $idx => $resep) {
                      ...
                      <tr class="text-top">
                        ...
                        <td class="text-top">
                          <span class="font-tr-table">Status Pengiriman</span><br>
                          <?= $resep->metode_pengambilan_obat == '1' ? 'Dikirim' : 'Diambil Sendiri' ?>
                        </td>
