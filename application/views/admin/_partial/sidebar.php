    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <div class="logo">
                    <a href="#" class="">
                      <div class="bg-logo-sidebar p-4"><img class="pl-2" src="<?php echo base_url('assets/telemedicine/img/logo.png'); ?>" alt=""><span></span></div>
                    </a>
                </div>
                <ul>
                    <?php if ($user->id_user_level == 1) { ?>
                        <li class="<?php if (isset($this->uri->segments[2])) {
                            ...
                            <a href="<?php echo base_url('admin/admin') ?>" style="font-size: 16px"><!-- <i class="fa fa-dashboard"></i>  -->
                                ...
                                <path d="M9 3H15V7.5H9V3ZM9 15.75V8.25H15V15.75H9ZM2.25 15.75V11.25H8.25V15.75H2.25ZM2.25 10.5V3H8.25V10.5H2.25ZM3 3.75V9.75H7.5V3.75H3ZM9.75 3.75V6.75H14.25V3.75H9.75ZM9.75 9V15H14.25V9H9.75ZM3 12V15H7.5V12H3Z"/>
                                </svg></i>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                ...
                                <li class="<?php echo strtolower($this->uri->segments[2]) == 'rumahsakit' ? 'active' : ''; ?>">
                                    <a href="<?php echo base_url('admin/RumahSakit/manage_rs') ?>"><span>Manage RS</span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="submenu">
                            <a href="#" class=""><!-- <i class="fas fa-truck"></i> -->
                                <i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path d="M19 7C19 5.9 18.1 5 17 5H14V7H17V9.65L13.52 14H10V9H6C3.79 9 2 10.79 2 13V16H4C4 17.66 5.34 19 7 19C8.66 19 10 17.66 10 16H14.48L19 10.35V7ZM4 14V13C4 11.9 4.9 11 6 11H8V14H4ZM7 17C6.45 17 6 16.55 6 16H8C8 16.55 7.55 17 7 17Z" fill="white"/>
                                    <path d="M5 6H10V8H5V6ZM19 13C17.34 13 16 14.34 16 16C16 17.66 17.34 19 19 19C20.66 19 22 17.66 22 16C22 14.34 20.66 13 19 13ZM19 17C18.45 17 18 16.55 18 16C18 15.45 18.45 15 19 15C19.55 15 20 15.45 20 16C20 16.55 19.55 17 19 17Z" fill="white"/>
                                    </svg></i>
                        ...
                        <li class="submenu">
                            <a href="#" class="<?php //cho strtolower($this->uri->segments[3]) == 'jadwal_dokter' ? 'active' : ''; ?>"><!-- <i class="far fa-calendar-alt"></i> -->
                                <i><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                    <path d="M5.25 8.25H6.75V9.75H5.25V8.25ZM15.75 4.5V15C15.75 15.825 15.075 16.5 14.25 16.5H3.75C3.35218 16.5 2.97064 16.342 2.68934 16.0607C2.40804 15.7794 2.25 15.3978 2.25 15L2.2575 4.5C2.2575 3.675 2.9175 3 3.75 3H4.5V1.5H6V3H12V1.5H13.5V3H14.25C15.075 3 15.75 3.675 15.75 4.5ZM3.75 6H14.25V4.5H3.75V6ZM14.25 15V7.5H3.75V15H14.25ZM11.25 9.75H12.75V8.25H11.25V9.75ZM8.25 9.75H9.75V8.25H8.25V9.75Z" fill="white"/>
                                    </svg></i>
                        ...
                        <li class="<?php if (isset($this->uri->segments[3])) {
                            ...
                            <a href="<?php echo base_url('admin/pasien/antrian_pasien') ?>"><!-- <i class="fas fa-stream"></i> -->
                                <i><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                    <path d="M5.625 3.375H15.75V4.5H5.625V3.375Z" fill="white"/>
                                    <path d="M5.625 6.75H15.75V7.875H5.625V6.75Z" fill="white"/>
                                    <path d="M8.4375 10.125H15.75V11.25H8.4375V10.125Z" fill="white"/>
                                    <path d="M5.625 13.5H15.75V14.625H5.625V13.5Z" fill="white"/>
                                    <path d="M2.25 7.875L6.1875 10.6875L2.25 13.5V7.875Z" fill="white"/>
                                    </svg></i>
                     ...
                     <?php } else { ?>
                        ...
                        <li class="<?php echo strtolower($this->uri->segments[2]) == 'pengambilanobat' ? 'active' : ''; ?>">
                            <a href="<?php echo base_url('admin/PengambilanObat') ?>"><i class="fa fa-shopping-bag"></i> <span>Pengambilan Obat</span></a>
                        </li>
                        <li class="submenu">
                            <a href="#" class=""><!-- <i class="fas fa-truck"></i> -->
                                <i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
