  ...
  <div class="content">
          ...
          <div class="col-sm-12 col-12 ">
            <nav aria-label="">
                <ol class="breadcrumb" style="background-color: transparent;">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="" class="text-black font-bold-7">Edit Admin Apotek</a></li>
                </ol>
            </nav>
          </div>
      </div> 
      <div class="row">
        <div class="col-lg-12">  
          <?= form_open_multipart('admin/AdminApotek/update/'.$data->id, 'id="form-edit-admin" onsubmit="return ubah();"'); ?>
              ...
              <div class="col-md-4">
                <div class="form-group form-focus">
                    <label class="focus-label">Apotek</label>
                      <select class="form-control floating" name="id_apotek" id="apotek" required>
                      <?php if(!$data->id_apotek){ ?>
                            <option value="<?php echo $data->id_apotek ?>" selected><?php echo $data->nama_apotek ?></option>
                        <?php } else { ?>
