                            ...
                            <tbody class="font-14">
                                ...
                                if (count($list_pembayaran) > 0) {
                                    foreach ($list_pembayaran as $idx => $pembayaran) {
                                        ...
                                        $metode_pembayaran = $pembayaran['metode_pembayaran'] == 1 ? 'Upload Owlexa' : ($pembayaran['metode_pembayaran'] == 2 ? 'Owlexa' : ($pembayaran['metode_pembayaran'] == 3 ? 'Virtual Account' : ($pembayaran['metode_pembayaran'] == 4 ? 'Dompet Digital - ' . $dompet_digital : 'Credit Card / Debit Card')));
                                        echo "<tr>";
                                        echo "<td>" . $idx++ . "</td>";
