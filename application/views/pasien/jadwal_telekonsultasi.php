                        ...
                        <?php
                            if(count($list_jadwal_konsultasi) > 0){
                                foreach($list_jadwal_konsultasi as $idx => $jadwal_konsultasi){
                                    ...
                                    echo "<td>".$tanggal."</td>";
                                    echo "<td>".$hari."</td>";
                                    echo "<td>".$jadwal_konsultasi->jam.' - '.(new DateTime($jadwal_konsultasi->jam))->modify('+'.$jadwal_konsultasi->durasi.' Seconds')->format('H:i').' WIB'." (Max. ".($jadwal_konsultasi->durasi/60)." Menit)</td>";
