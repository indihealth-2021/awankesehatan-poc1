  ...
  <div class="content">
          ...
          <div class="col-sm-12 col-12 ">
            <nav aria-label="">
                <ol class="breadcrumb" style="background-color: transparent;">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="<?php echo base_url('admin/apotek/form_apotek') ?>" class="text-black font-bold-7">Edit Apotek</a></li>
                </ol>
            </nav>
          </div>
      </div> 
      <div class="row">
        <div class="col-lg-12">
          <?= form_open_multipart('admin/apotek/updateApotek/'.$data->id, 'id="form-add-apotek" onsubmit="return ubah();" autocomplete="off"'); ?>
            <p class="title-form">Data Apotek</p>
            <div class="row">
            <div class="col-md-6">
                <div class="form-group form-focus">
                    <label class="focus-label">Nama</label>
                    <input type="text" class="form-control floating" name="nama" id="name" value="<?= $data->nama ?>" required placeholder="Masukan Nama Apotek">
                </div>
              </div> 
              <div class="col-md-6">
                <div class="form-group form-focus">
                    <label class="focus-label">Nomor Telepon</label>
                    <input type="number" class="form-control floating" name="telp" id="telp" value="<?= $data->telp ?>" required placeholder="Masukan Nomor Telepon">
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group form-focus">
                    ...
                    <input type="text" class="form-control floating" name="kode_pos" value="<?php echo $data->kode_pos ?>" required placeholder="Masukan Kode Pos">
                </div>
              </div> 
              <div class="col-md-4">
                <div class="form-group form-focus">
                ...
                <div class="form-group gender-select">
                  <div class="form-check-inline">
                    <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="aktif" id="status" value=1 <?php echo $data->aktif ? "checked" : ""?> required>Aktif
                    </label>
                  </div>
                  <div class="form-check-inline pl-2">
                    <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="aktif" id="status" value=0 <?php echo $data->aktif ? "" : "checked"?> required>Non Aktif
                    </label>
                  </div>
                </div>
              </div>
