          ...
          <div class="font-18">
            ...
            <div class="mt-5">
              ...
              <div class="form-group row" style="display: <?= $dikirim ? "block" : "none" ?>;">
                ...
                <label for="alamat" class="col-md-4 mt-2 text-abu">
                  Alamat Pengiriman Obat :
                </label>
                <div class="col-md-6">
                  <div class="" id="form_pembayaran">
                    <textarea class="form-control" id="alamat" name="alamat" readonly required></textarea>
                  </div>
              ...
              <div class="form-group row">
                <label for="metode-pembayaran" class="col-md-3 mt-2 text-abu">
                  Upload Owlexa
                </label>
                <div class="col-md-6">
