      ...
      <div class="col-sm-12 col-12 ">
        <nav aria-label="">
          <ol class="breadcrumb" style="background-color: transparent;">
            ...
            <li class="breadcrumb-item" aria-current="page"><a href="<?php echo base_url('admin/apotek') ?>" class="text-black font-bold-7">Apotek Management</a></li>
          </ol>
        </nav>
      </div>
      <div class="col-sm-12 col-12">
        <h3 class="page-title">Apotek Management</h3>
      </div>
      <div class="col-sm-12 col-12">
        <h7 class="page-subtitle">Apotek</h7>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <!-- <ul class="nav nav-tabs nav-tabs-bottom">
                <li class="nav-item"><a class="nav-link active" href="" data-toggle="tab">apotek</a></li>
            </ul> -->
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="container-1">
                  ...
                  <input type="search" id="search" style="background: #ffffff !important;" placeholder="Cari Apotek Disini" />
                </div>
                <div class="">
                  <a href="<?php echo base_url('admin/apotek/form_apotek') ?>" class="btn btn btn-tele btn-rounded float-right  "><i class="fa fa-plus"></i> Tambah Apotek</a>
                </div>
              </div>
              <div class="table-responsive pt-4">
                <table class="table table-border table-hover custom-table mb-0" id="table_apotek">
                  <thead class="text-tr">
                  ...
                  <tbody class="font-14">
                    <?php foreach ($list_apotek as $idx => $apotek) { ?>
                      <tr>
                        <td><?php echo $apotek->id ?></td>
                        <td><?php echo ucwords($apotek->nama) ?>
                        <td><?php echo $apotek->alamat_jalan . ", " ?></td>
                        <td><?php echo $apotek->telp ?></td>
                        <!--  <td class="text-center"><a href="" class="font-14 text-detail">Lihat Detail</a></td> -->
                        <td class="text-center"><?php echo $apotek->aktif == 1 ? '<span class="status-aktif">Aktif</span>' : '<span class="status-nonaktif">Tidak Aktif</span>' ?></td>
                        <td>
                          <a class="font-icon" href="#modalHapus" data-toggle="modal" data-href="<?php echo base_url('admin/apotek/hapusapotek/' . $apotek->id); ?>" data-nama="<?php echo $apotek->nama ?>" onclick="$('#modalHapus #form')">
                          ...
                          <a class="mx-3" href="<?php echo base_url('admin/apotek/tampilEditapotek/' . $apotek->id); ?>">
                            <i><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title font-modal-header p-3">Hapus Data apotek</h5>
      </div>
      <form method="post" action="<?php echo base_url('admin/apotek/hapusApotek/' . $apotek->id); ?>">
        <div class="modal-body font-modal-body">
          <p class="p-3">Anda yakin ingin menghapus data apotek <b id="nama"></b> ?</p>
        </div>
...
<?php echo $this->session->flashdata('msg_edit_apotek') ? "<script>alert('" . $this->session->flashdata('msg_edit_apotek') . "')</script>" : ''; ?>
<?php echo $this->session->flashdata('msg_hps_apotek') ? "<script>alert('" . $this->session->flashdata('msg_hps_apotek') . "')</script>" : ''; ?>